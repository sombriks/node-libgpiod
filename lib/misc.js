...
module.exports = {
	...
	getInstantLineValue(chipNumber, lineNumber, { activeLow = false, consumer = '', flags } = {}) {
		if (flags) return libgpiod.getInstantLineValueFlags(chipNumber, lineNumber, activeLow, consumer, flags);
		else return libgpiod.getInstantLineValue(chipNumber, lineNumber, activeLow, consumer);
	},
	/**
	...
	setInstantLineValue(chipNumber, lineNumber, value, { activeLow = false, consumer = '', callback = () => { }, flags } = {}) {
		if (flags) return libgpiod.setInstantLineValueFlags(chipNumber, lineNumber, value, activeLow, consumer, callback, flags);
		else return libgpiod.setInstantLineValue(chipNumber, lineNumber, value, activeLow, consumer, callback);
	},
	/**
	...
	getInstantLineValues(chipNumber, lineNumbers, { activeLow = false, consumer = '', flags } = {}) {
		if (flags) return libgpiod.getInstantLineValuesFlags(chipNumber, lineNumbers, activeLow, consumer, flags);
		else return libgpiod.getInstantLineValues(chipNumber, lineNumbers, activeLow, consumer);
	},
	/**
	...
	setInstantLineValues(chipNumber, lineNumbers, values, { activeLow = false, consumer = '', callback = () => { }, flags } = {}) {
		if (flags) libgpiod.setInstantLineValuesFlags(chipNumber, lineNumbers, values, activeLow, consumer, callback, flags);
		else libgpiod.setInstantLineValues(chipNumber, lineNumbers, values, activeLow, consumer, callback);
	},
};
