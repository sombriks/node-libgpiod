...
module.exports = {
	 ...
	 */
	getInstantLineValue(chipNumber, lineNumber, activeLow = false, consumer = '') {
	 ...
	 */
	setInstantLineValue(chipNumber, lineNumber, value, activeLow = false, consumer = '', callback = () => {}) {
	 ...
	 */
	getInstantLineValues(chipNumber, lineNumbers, activeLow = false, consumer = '') {
	 ...
	 * @param {function} [callback] - The callback function to call when the operation is complete
	 */
	setInstantLineValues(chipNumber, lineNumbers, values, activeLow = false, consumer = '', callback = () => {}) {
	 ...
	 * @returns {0|1} - The current value of the line
	 */
	getInstantLineValueFlags(chipNumber, lineNumber, activeLow = false, consumer = '', flags) {
	 ...
	 * @param {InstantFlags} [flags] - The flags to use for the operation
	 */
	setInstantLineValueFlags(chipNumber, lineNumber, value, activeLow = false, consumer = '', callback = () => {}, flags) {
	 ...
	 * @returns {Array<number>} - An array of current values for the lines
	 */
	getInstantLineValuesFlags(chipNumber, lineNumbers, activeLow = false, consumer = '', flags) {
	 ...
	 * @param {InstantFlags} [flags] - The flags to use for the operation
	 */
	setInstantLineValuesFlags(chipNumber, lineNumbers, values, activeLow = false, consumer = '', callback = () => {}, flags) {
