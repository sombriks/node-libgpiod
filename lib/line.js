...
class Line {
   ...
   * 
   */
  get offset() { return libgpiod.getLineOffset(this._handler) }

  /**
   * @property name - The line name
   * @returns {string} - The line name
   */
  get name() { return libgpiod.getLineName(this._handler) }
   ...
   * @param {0|1} [defaultValue] - default value to set
   */
  requestOutputMode(consumer = "", defaultValue = 0) { return libgpiod.requestOutputMode(this._handler, consumer, defaultValue) }

  /**
   * requestRisingEdgeEvents 
   * @param {string} [consumer] - consumer name
   */
  requestRisingEdgeEvents(consumer = "") { return libgpiod.requestRisingEdgeEvents(this._handler, consumer) }

  /**
   * requestRisingEdgeEvents
   * @param {string} [consumer] - consumer name
   */
  requestFallingEdgeEvents(consumer = "") { return libgpiod.requestFallingEdgeEvents(this._handler, consumer) }

  /**
   * requestBothEdgesEvents
   * @param {string} [consumer] - consumer name
   */
  requestBothEdgesEvents(consumer = "") { return libgpiod.requestBothEdgesEvents(this._handler, consumer) }
   ...
   */
  requestInputModeFlags(consumer, flags) { return libgpiod.requestInputModeFlags(this._handler, consumer, flags) }
   ...
   */
  requestOutputModeFlags(consumer, flags, defaultValue = 0) { return libgpiod.requestOutputModeFlags(this._handler, consumer, flags, defaultValue) }
   ...
   * @param {Line.RequestFlags} flags  - request flags bits
   */
  requestRisingEdgeEventFlags(consumer, flags) { return libgpiod.requestRisingEdgeEventFlags(this._handler, consumer, flags) }
   ...
   * @param {Line.RequestFlags} flags  - request flags bits
   */
  requestFallingEdgeEventFlags(consumer, flags) { return libgpiod.requestFallingEdgeEventFlags(this._handler, consumer, flags) }
   ...
   * @param {Line.RequestFlags} flags  - request flags bits
   */
  requestBothEdgesEventFlags(consumer, flags) { return libgpiod.requestBothEdgesEventFlags(this._handler, consumer, flags) }

  /**
   * release - release the line
   */
  release() { return libgpiod.release(this._handler) }
}
